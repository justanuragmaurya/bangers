      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-primary/60 mt-2 max-w-xs">
              Transform your YouTube videos into viral tweets with AI-powered content generation.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-primary/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-primary/60">
            © {currentYear} Bangers. All rights reserved.
          </p>
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <Link 
              href="https://github.com/justanuragmaurya" 
              target="_blank"
